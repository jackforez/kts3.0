...
const Footer = () => {
  return (
    <footer className=" bg-white p-4 sm:p-6">
      <div className="mx-auto max-w-screen-lg md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
          <a href="https://ktscorp.vn" className="flex items-center">
      ...
      <div className="sm:flex sm:items-center justify-center">
        <span className="text-sm text-gray-500  sm:text-center">
          © 2023
          <a href="https://ktscorp.vn/" className="hover:underline">
            KTScorp™
          </a>
          . All Rights Reserved.
        </span>
