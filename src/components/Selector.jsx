...
const Selector = ({ placehoder }) => {
  ...
  return (
    <div className="w-full border border-green-500 rounded">
      ...
      />
      <div className="h-36 overflow-y-auto divide-green-500/10 divide-y">
        {search(data, query, "name_with_type").length > 0 ? (
