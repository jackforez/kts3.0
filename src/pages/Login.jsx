...
const Login = () => {
  ...
  return (
    <div className="bg-[url('./assets/imgs/img1.jpg')] md:bg-[url('./assets/imgs/hero.jpg')] h-screen bg-cover bg-fixed bg-center bg-no-repeat overflow-hidden flex justify-start items-center">
      ...
      <div className="lg:w-1/4 md:w-1/3 w-full h-full py-4 md:p-0 justify-between flex text-white backdrop-blur rounded overflow-hidden drop-shadow bg-opacity-10 items-center">
