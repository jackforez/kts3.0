...
const Login = () => {
  ...
  return (
    <div className="bg-[url('./assets/imgs/img1.jpg')] md:bg-[url('./assets/imgs/hero.jpg')] h-screen bg-cover bg-fixed bg-center bg-no-repeat overflow-hidden flex justify-start items-center">
      ...
      <div className="lg:w-1/4 md:w-1/3 w-full h-full py-4 md:p-0 justify-between bg-black-900 flex text-white backdrop-blur rounded overflow-hidden drop-shadow bg-opacity-10 items-center">
        <div className="w-full px-6 md:space-y-8">
          <Link
            title="Trang chủ"
            to="/"
            className="underline underline-offset-4 text-gray-400 hover:text-white"
          ...
          <form className="w-full space-y-3" action="">
            ...
            <div className="w-full md:flex justify-center hidden gap-1.5 py-2 text-center">
              <a
                href="#"
                className="text-gray-500 hover:text-white"
                title="Facebook page"
